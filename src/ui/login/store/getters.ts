...
export const getters = {
  logInInteractor: (): UserLogInInteractor => container.get<UserLogInInteractor>(TYPES.UserLogInInteractor),
  userHasSessionInteractor: (): UserHasSessionInteractor =>
    container.get<UserHasSessionInteractor>(TYPES.UserHasSessionInteractor),
};
